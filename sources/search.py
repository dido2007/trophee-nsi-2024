...
"""
Cette fonction normalise la requête en supprimant les mots inutiles et en convertissant le texte en minuscules.
"""
...
"""
Cette fonction permet de rechercher des mots-clés dans les données extraites par le crawler dans le CSV keywords mis en paramètre.
Elle renvoie les 5 premiers résultats les plus pertinents en fonction de la fréquence.
"""
def search_keywords(query, pathKeywords, pathWebpages):
    normalized_keywords = normalize_query(query)
    urls_scores = {}

    try:
        with open(pathKeywords, mode='r', newline='', encoding='utf-8') as file:
    ...
    results = []
    try:
        with open(pathWebpages, mode='r', newline='', encoding='utf-8') as file:
